        ...
        <page status="">
            <div id="main">
                ...
                <xsl:if test="//page/payment">
                    ...
                    <form id="payment_form" name="frmCardInfo" method="post" action="/jsp/process/auth.jsp" onSubmit="frmSmt();"   >
                        ...
                        <div>
                            <span>
                                <TR>
                                    <TD colspan="2"><br/>
                                        <xsl:text> </xsl:text>
                                        <input type="button" class="button-back" value="pay for another service" onclick='location.href="/iphone/success"'  i18n:attr="value"/>
