...
$order_id = 67;				// Порядковый номер заказа - преобразуется в формат "000001"
...
<form name="SendOrder" method="post" action="https://testpay.kkb.kz/jsp/process/logon.jsp">
   ...
   E-mail: <input type="text" name="email" size=50 maxlength=50  value="info@radiocity.kz">
   <p>
   ...
   <input type="hidden" name="PostLink" value="http://radiocity.kz/paytest/postlink.php">
